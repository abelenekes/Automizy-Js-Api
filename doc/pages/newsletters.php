<section>
    ...
    <div class='module-description'>
        ...
        To see detailed structure and functionality of newsletters, check the <a href="<?= $config['urls']['restApiDoc'] ?>#Newsletters" target='_blank'>Automizy REST API Docs</a>
    </div>
            ...
            <td class='function-body'>
                <article>
                    ...
                    <div class='function-description'>
                        ...
                        <code>id</code>: The id of the newsletter you want to copy.<br>
